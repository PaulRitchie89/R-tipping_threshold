...
for j in range(len(t)-1):
    ...
    if t[j] in times:
        ...
        ax3[int(count/2),count%2].plot(Edge_FPR,Edge_TPR,label='R-tipping threshold')
...
ax4[2].plot(t[1:-1],Edge_OptThr[1:]-Edge_OptThr[-1],label='R-tipping threshold')
...
ax5[0].plot(t[:-1],1-Edge_minFPR,label='R-tipping threshold specificity')
...
ax5[1].plot(t[:-1],Edge_maxTPR,label='R-tipping threshold sensitivty')
